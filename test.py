...
sympList = ['--Select Symptom--', 'headache', 'sneezing', 'runny_nose', 'sore_throat', 'fever', 'chills', 'bodyache',
...
class DPDP:
    ...
    def __init__(self, master):
        ...
        # -------Symptom1-------------------------
        symp1 = Label(root, text="1st Symptom",
        ...
        self.symp2 = Label(root, text="2nd Symptom",
                           font=('Verdana 15'), bg='#44689E')
        ...
        self.symp3 = Label(root, text="3rd Symptom",
                           font=('Verdana 15'), bg='#44689E')
...
def queryGenerator(s1, s2, s3, s4):
    ...
    q = list(prolog.query("telldisease(X,%s,%s,%s,%s)." % (s1, s2, s3, s4)))  # prolog query
   # for e in q[0].values():
   # print("You have " + e)
   # break
    print(q)
    tkinter.messagebox.showinfo(title=str(q), message=str(q))
